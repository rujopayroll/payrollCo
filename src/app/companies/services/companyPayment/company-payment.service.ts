...
private URL_SERVICIOS: string = environment.URL_SERVICIOS;
  ...
  constructor( public http: HttpClient,
    ...
    cargarCompanyPayment( id: string){
      ...
      let url = this.URL_SERVICIOS + '/companyPayment/' + id;
    ...
    crearCompanyPayment( companyPayment: CompanyPayment){
      const url = this.URL_SERVICIOS + '/companyPayment';
      return this.http.post( url, companyPayment, {withCredentials:true})
      .pipe(
          map( (resp: any) =>{
    ...
    actualizarCompanyPayment( companyPayment: any ){
      ...
      let url = this.URL_SERVICIOS + '/companyPayment/' + companyPayment.id;

      return this.http.put( url, companyPayment, {withCredentials:true})
      .pipe(
          map( (resp: any) =>{
